...
<a (click)="gotoPredefinedResults('canned_query:coding_genes_with_mf_and_bp_annotation')">
{{getPredefinedQueryCount('canned_query:coding_genes_with_mf_and_bp_annotation') | async}}
</a>
of the
