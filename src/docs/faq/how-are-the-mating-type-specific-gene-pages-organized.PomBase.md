...
The DNA seqence of the WT [silent mating type region](/documentation/non-gene-features) containing the mat2 and mat3 genes was reconstructed yielding an extra [mating type region contig](/downloads/genome-datasets) (see 'current genome' link). Only the P genes from this contig have gene pages in PomBase. 
