...
| [canto_go_annotations_with_comments.parquet](https://www.pombase.org/latest_release/training_data_for_ML_and_AI/canto_go_annotations_with_comments.parquet) | Same as above, in [Parquet format](https://en.wikipedia.org/wiki/Apache_Parquet)
